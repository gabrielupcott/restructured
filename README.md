...
Alpha 4 filled in the rest of the content: 62 verified problems across all eleven tracks of the planned curriculum, with 11 hard problems and a capstone closing out most tracks. Problems inside a track follow a teaching order, and solving one unlocks the next. Linked lists, trees, and graphs hand you real node objects now, and solutions that mutate their input get a fresh copy for every timed run.
